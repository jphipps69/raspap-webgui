...
function DisplayDashboard(){
	...
	if(strpos( $strWlan0, "UP" ) !== false) {
		$status->addMessage('Client Interface is up', 'success');
		$wlan0up = true;
	} else {
		$status->addMessage('Client Interface is down', 'warning');
	}
	...
	// Parse results from ifconfig/iwconfig
	preg_match( '/link\/ether ([0-9a-f:]+)/i',$strWlan1,$result ) || $result[1] = 'No MAC Address Found';
	$strHWAddress2 = $result[1];
	preg_match_all( '/inet ([0-9.]+)/i',$strWlan1,$result ) || $result[1] = 'No IP Address Found';
	$strIPAddress2 = '';
	foreach($result[1] as $ip) {
		$strIPAddress2 .= $ip." ";
	}
	preg_match_all( '/[0-9.]+\/([0-3][0-9])/i',$strWlan1,$result ) || $result[1] = 'No Subnet Mask Found';
	$strNetMask2 = '';
	foreach($result[1] as $netmask) {
		$strNetMask2 .= long2ip(-1 << (32 -(int)$netmask))." ";
	}
	preg_match( '/RX packets:(\d+)/',$strWlan1,$result ) || $result[1] = 'No Data';
	$strRxPackets2 = $result[1];
	preg_match( '/TX packets:(\d+)/',$strWlan1,$result ) || $result[1] = 'No Data';
	$strTxPackets2 = $result[1];
	preg_match( '/RX bytes:(\d+ \(\d+.\d+ [K|M|G]iB\))/i',$strWlan1,$result ) || $result[1] = 'No Data';
	$strRxBytes2 = $result[1];
	preg_match( '/TX Bytes:(\d+ \(\d+.\d+ [K|M|G]iB\))/i',$strWlan1,$result ) || $result[1] = 'No Data';
	$strTxBytes2 = $result[1];
	preg_match( '/ESSID:\"([a-zA-Z0-9\s].+)\"/i',$strWlan1,$result ) || $result[1] = 'Not connected';
	$strSSIDs = str_replace( '"','',$result[1] );
	preg_match( '/Access Point: ([0-9a-f:]+)/i',$strWlan1,$result ) || $result[1] = '';
	$strBSSIDs = $result[1];
	preg_match( '/Bit Rate=([0-9\.]+ Mb\/s)/i',$strWlan1,$result ) || $result[1] = '';
	$strBitrate2 = $result[1];
	preg_match( '/Tx-Power=([0-9]+ dBm)/i',$strWlan1,$result ) || $result[1] = '';
	$strTxPower2 = $result[1];
	preg_match( '/Link Quality=([0-9]+)/i',$strWlan1,$result ) || $result[1] = '';
	$strLinkQuality2 = $result[1];
	preg_match( '/Signal level=(-?[0-9]+ dBm)/i',$strWlan1,$result ) || $result[1] = '';
	$strSignalLevel2 = $result[1];
	preg_match('/Frequency:(\d+.\d+ GHz)/i',$strWlan1,$result) || $result[1] = '';
	$strFrequency2 = $result[1];
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="info-item">
                                        Interface Name
                                    </div><?php echo RASPI_WIFI_CLIENT_INTERFACE ?><br>

                                    <div class="info-item">
                                        IP Address
                                    </div><?php echo $strIPAddress ?><br>

                                    <div class="info-item">
                                        Subnet Mask
                                    </div><?php echo $strNetMask ?><br>

                                    <div class="info-item">
                                        Mac Address
                                    </div><?php echo $strHWAddress ?><br>
                                    <br>
                                    ...
                                    <div class="info-item">
                                        Received Packets
                                    </div><?php echo $strRxPackets ?><br>

                                    <div class="info-item">
                                        Received Bytes
                                    </div><?php echo $strRxBytes ?><br>
                                    <br>

                                    <div class="info-item">
                                        Transferred Packets
                                    </div><?php echo $strTxPackets ?><br>

                                    <div class="info-item">
                                        Transferred Bytes
                                    </div><?php echo $strTxBytes ?><br>
                                </div><!-- /.panel-body -->
                            </div><!-- /.panel-default -->
                        </div><!-- /.col-md-6 -->
                        <!-- start of AP -->
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="info-item">
                                        Interface Name
                                    </div><?php echo RASPI_WIFI_AP_INTERFACE ?><br>

                                    <div class="info-item">
                                        IP Address
                                    </div><?php echo $strIPAddress2 ?><br>

                                    <div class="info-item">
                                        Subnet Mask
                                    </div><?php echo $strNetMask2 ?><br>

                                    <div class="info-item">
                                        Mac Address
                                    </div><?php echo $strHWAddress2 ?><br>
                                    <br>
                                    ...
                                    <div class="info-item">
                                        Received Packets
                                    </div><?php echo $strRxPackets2 ?><br>

                                    <div class="info-item">
                                        Received Bytes
                                    </div><?php echo $strRxBytes2 ?><br>
                                    <br>

                                    <div class="info-item">
                                        Transferred Packets
                                    </div><?php echo $strTxPackets2 ?><br>

                                    <div class="info-item">
                                        Transferred Bytes
                                    </div><?php echo $strTxBytes2 ?><br>
                                </div><!-- /.panel-body -->
                            </div><!-- /.panel-default -->
                        </div><!-- /.col-md-6 -->
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-default">
                                <div class="panel-body wireless">
                                    <h4>Client Wireless Information</h4>

                                    <div class="info-item">
                                        Connected To
                                    </div><?php echo $strSSID ?><br>

                                    <div class="info-item">
                                        AP Mac Address
                                    </div><?php echo $strBSSID ?><br>

                                    <div class="info-item">
                                        Bitrate
                                    </div><?php echo $strBitrate ?><br>

                                    <div class="info-item">
                                        Signal Level
                                    </div><?php echo $strSignalLevel ?><br>

                                    <div class="info-item">
                                        Transmit Power
                                    </div><?php echo $strTxPower ?><br>

                                    <div class="info-item">
                                        Frequency
                                    </div><?php echo $strFrequency ?><br>
                                    <br>
                         ...
                         <div class="col-md-6">
                            <div class="panel panel-default">
                                <div class="panel-body wireless">
                                    <h4>AP Wireless Information</h4>

                                    <div class="info-item">
                                        Connected To
                                    </div><?php echo $strSSID2 ?><br>

                                    <div class="info-item">
                                        AP Mac Address
                                    </div><?php echo $strBSSID2 ?><br>

                                    <div class="info-item">
                                        Bitrate
                                    </div><?php echo $strBitrate2 ?><br>

                                    <div class="info-item">
                                        Signal Level
                                    </div><?php echo $strSignalLevel2 ?><br>

                                    <div class="info-item">
                                        Transmit Power
                                    </div><?php echo $strTxPower2 ?><br>

                                    <div class="info-item">
                                        Frequency
                                    </div><?php echo $strFrequency2 ?><br>
                                    <br>
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-info progress-bar-striped active" role="progressbar" aria-valuenow="<?php echo $strLinkQuality2 ?>" aria-valuemin="0" aria-valuemax="100" style="width: &lt;?php echo $strLinkQuality2 ?&gt;%;">
                                            <?php echo $strLinkQuality2 ?>%
                                        </div>
                                    </div>
                                </div><!-- /.panel-body -->
                            </div><!-- /.panel-default -->
