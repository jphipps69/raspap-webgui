                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <form action="?page=wlan0_info" method="post">
                                <?php if ( !$wlan0up ) {
                                        echo '<input type="submit" class="btn btn-success" value="Start Cleint ' . RASPI_WIFI_CLIENT_INTERFACE . '" name="ifup_wlan0" />';
                                    } else {
                                        echo '<input type="submit" class="btn btn-warning" value="Stop Client ' . RASPI_WIFI_CLIENT_INTERFACE . '" name="ifdown_wlan0" />';
                                    }
